package com.cts.springboot.configuration;
...
@Configuration
@EnableJpaRepositories(basePackages = "com.cts.springboot.repositories",
...
public class JpaConfiguration {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
		...
		factoryBean.setPackagesToScan(new String[] { "com.cts.springboot.model" });
